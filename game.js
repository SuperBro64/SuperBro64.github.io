...
var levelSetup =
{
    ...
    titleScreen: function()
    {
        ...
        music.changeLoopEndpoints(0.000, 37.662); music.play(); // First Loop Point: 18.831 sec.
    ...
    credits: function()
    {
        ...
        music.changeLoopEndpoints(3.499, 170.457); music.play(); // First Loop Point: 86.978 sec.
    },
    ...
    mainHub: function()
    {
        ...
        {
            music.sound.src = "resources/sounds/Super_Monkey_Ball_2_-_Clear.mp3";
            music.changeLoopEndpoints(1.650, 34.212); // First Loop Point: 17.931 sec.
        }
        else
        {
            music.sound.src = "resources/sounds/Super_Monkey_Ball_2_-_Menu.mp3";
            music.changeLoopEndpoints(1.172, 33.702); // First Loop Point: 17.437 sec.
        }
        music.play();
    },
    ...
    level5: function()
    {
        ...
        music.sound.src = "resources/sounds/Super_Monkey_Ball_2_-_World_5.mp3";
        music.changeLoopEndpoints(0.000, 126.310); music.play(); // First Loop Point: 63.155 sec.
    },
    ...
    level9: function()
    {
        ...
        walls = [(new componentWall(880, 160, 20, 99, colors.Tomato, 2, colors.Black, true, "Cracked", 0)),
                 ...
                 (new componentWall(770, 279, 20, 100, colors.Orange, 2, colors.Black, false, "Flip", -1)),
                 (new componentWall(770, 519, 20, 100, colors.Orange, 2, colors.Black, false, "Flip", -1)),
                 (new componentWall(630, 279, 20, 100, colors.SkyBlue, 2, colors.Black, true, "Flip", -2)),
                 (new componentWall(630, 519, 20, 100, colors.SkyBlue, 2, colors.Black, true, "Flip", -2)),
                 (new componentWall(510, 259, 120, 20, colors.Orange, 2, colors.Black, false, "Flip", -1)),
                 (new componentWall(-1, 140, 211, 20, colors.SaddleBrown, 2, colors.Black, true, "Door", 1)),
                 (new componentWall(900, 140, 125, 20, colors.SaddleBrown, 2, colors.Black, true, "Door", 2)),
                 (new componentWall(210, -1, 20, 640, colors.Gray, 2, colors.Black, true, "N/A", 0)),
                 (new componentWall(230, 140, 670, 20, colors.Gray, 2, colors.Black, true, "N/A", 0)),
                 (new componentWall(230, 619, 670, 20, colors.Gray, 2, colors.Black, true, "N/A", 0))];
        holes = [];
        treasure = [(new componentTreasure(42.5, 619, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    ...
                    (new componentTreasure(290, 724, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(490, 684, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(690, 724, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(505, 80, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(705, 80, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(977, 449, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(710, 569, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(907, 329, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(710, 269, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(570, 389, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(500, 210, 10, 0, 2, colors.Gold, 2, colors.Black)),
    ...
    levelA: function()
    {
        ...
        walls = [(new componentWall(462, 300, 100, 10, colors.SaddleBrown, 2, colors.Black, true, "Door", 1)),
                 ...
                 (new componentWall(492, 656, 40, 113, colors.Gray, 2, colors.Black, true, "N/A", 0)),
                 ...
                 (new componentWall(-1, 420, 313, 40, colors.Gray, 2, colors.Black, true, "N/A", 0)),
                 (new componentWall(712, 420, 313, 40, colors.Gray, 2, colors.Black, true, "N/A", 0)),
        ...
        treasure = [(new componentTreasure(215, 90, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    ...
                    (new componentTreasure(375, 375, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(649, 375, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    ...
                    (new componentTreasure(375, 504, 10, 0, 2, colors.Gold, 2, colors.Black)),
                    (new componentTreasure(649, 504, 10, 0, 2, colors.Gold, 2, colors.Black)),
        ...
        resizers = [];
        teleporters = [];
        burners = [(new componentBurner(152, 146, 130, 30, colors.LightGray, 2, colors.Black, 2, "ON", true)),
                   (new componentBurner(742, 146, 130, 30, colors.LightGray, 2, colors.Black, 2, "OFF", true)),
                   (new componentBurner(422, 199, 30, 101, colors.LightGray, 2, colors.Black, 2, "OFF", false)),
                   (new componentBurner(572, 199, 30, 101, colors.LightGray, 2, colors.Black, 2, "ON", false)),
                   (new componentBurner(112, 340, 30, 80, colors.LightGray, 2, colors.Black, 2, "OFF", false)),
                   (new componentBurner(882, 340, 30, 80, colors.LightGray, 2, colors.Black, 2, "ON", false)),
                   (new componentBurner(-1, 546, 113, 30, colors.LightGray, 2, colors.Black, 2, "OFF", false)),
                   (new componentBurner(912, 546, 113, 30, colors.LightGray, 2, colors.Black, 2, "ON", false)),
                   (new componentBurner(282, 460, 30, 86, colors.LightGray, 2, colors.Black, 2, "ON", false)),
                   (new componentBurner(712, 460, 30, 86, colors.LightGray, 2, colors.Black, 2, "OFF", false)),
                   (new componentBurner(202, 686, 30, 83, colors.LightGray, 2, colors.Black, 2, "ON", false)),
                   (new componentBurner(792, 686, 30, 83, colors.LightGray, 2, colors.Black, 2, "OFF", false)),
                   (new componentBurner(382, 656, 110, 30, colors.LightGray, 2, colors.Black, 2, "OFF", false)),
                   (new componentBurner(532, 656, 110, 30, colors.LightGray, 2, colors.Black, 2, "ON", false))];
    ...
    level$: function()
    {
        ...
        music.sound.src = "resources/sounds/Super_Monkey_Ball_2_-_Billiards.mp3";
        music.changeLoopEndpoints(4.402, 144.036); music.play(); // First Loop Point: 74.219 sec.
    }
}
...
function componentSound(source, type)
{
    ...
    this.sound.src = source; this.type = type, this.restartTime = 0.000, this.endTime = 0.000;
...
function levelEnd()
{
    ...
    sfx.sound.src = "resources/sounds/Super_Mario_64_-_Star_Catch.mp3"; sfx.play(); music.sound.playbackRate = 1.0;
    clearInterval(gameArea.interval); gameArea.interval = null;
}
